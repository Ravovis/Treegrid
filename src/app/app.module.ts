...
@NgModule({
  declarations: [AppComponent], imports: [CommonModule, HttpModule, TreeGridAllModule, TreeGridModule, NumericTextBoxAllModule, ToolbarModule, DropDownListAllModule, ButtonAllModule, DialogModule, MultiSelectAllModule, CheckBoxAllModule, ReactiveFormsModule, FormsModule, DatePickerModule, SparklineAllModule, BrowserModule], providers: [], bootstrap: [AppComponent]
})
